...
(function(){
  ...
  <?php if(C('COLOR_STYLE')=='blue_color') echo '
    <link href="/qjty/Public/static/datetimepicker/css/datetimepicker_blue.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet" type="text/css">
    '; ?>
  <link href="/qjty/Public/static/datetimepicker/css/dropdown.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet" type="text/css">
  <script type="text/javascript" src="/qjty/Public/static/datetimepicker/js/bootstrap-datetimepicker.js"></script> 
