...
<div id="container" class="container"> 
	<div class="head_hd">
        <a href="<?php echo ($jumpURL); ?>" class="start_btn" title="<?php echo ($button_name); ?>"><img src="<?php echo ADDON_PUBLIC_PATH;?>/bg.png" width="100%"></a>
     </div>
    <div class="content">
     	 <h4 style="word-wrap:break-word;"><?php echo ($info["title"]); ?></h4>
         <div class="detail_desc" style="word-wrap:break-word;"><?php echo ($info["intro"]); ?></div>
    </div> 
